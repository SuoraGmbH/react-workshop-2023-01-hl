...
const githubRepoFacebookReactSuccessMock = rest.get(
  ...
  (req, res, context) => {
    return res(
      context.json({
        ...
        updated_at: "2023-02-01T13:33:17Z",
        pushed_at: "2023-02-01T09:55:31Z",
        ...
        size: 240633,
        stargazers_count: 201310,
        watchers_count: 201318,
        language: "JavaScript",
        has_issues: true,
        has_projects: true,
        has_downloads: true,
...
export default githubRepoFacebookReactSuccessMock;
